...
const CA_KEY_SIZE           =  512; // XXX
const CLIENT_KEY_SIZE       =  512; // XXX
...
function createServer(state_in) {
  ...
  var state = {
    ...
    baseURL: "http://localhost:4000/acme/",
    authzBase: "http://localhost:4000/acme/authz/",
    certBase:  "http://localhost:4000/acme/cert/",
    keyPair: null,
    certificate: null,
