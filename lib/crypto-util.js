...
module.exports = {
  ...
  generateCertificate: function(ca, serialNumber, csr_b64) {
    var csrDer = bufferToBytes(util.b64dec(csr_b64));
    var csr = forge.pki.certificationRequestFromAsn1(forge.asn1.fromDer(csrDer));
